...
# TO_BUILD         : docker build --pull=true --no-cache --rm -t nikosd23/docker-maven-postgres:master . && docker tag nikosd23/docker-maven-postgres:master nikosd23/docker-maven-postgres:1.3 && docker tag nikosd23/docker-maven-postgres:1.3 nikosd23/docker-maven-postgres:latest
# TO_RUN           : docker run -it --volume=/Users/nikos/workspace/app:/localRepo --workdir="/localRepo" --memory=4g --entrypoint=/bin/bash adrienpessu/docker-maven-postgres
##
